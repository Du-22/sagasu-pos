...
const ArchivedSummaryNotice = ({
  ...
  const archiveMonth = monthlySummary?.month || monthlySummary?.id || "";
            ...
            {hasArchiveFiles && (
              <div className="mt-3 flex flex-col gap-2 border-t border-warm-sand pt-3 text-sm text-warm-charcoal sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-lg border border-warm-sand bg-parchment px-3 text-sm font-bold text-warm-charcoal hover:bg-warm-sand/30 disabled:cursor-not-allowed disabled:opacity-60"
                  title="重新驗證 POS 管理密碼後下載"
                >
